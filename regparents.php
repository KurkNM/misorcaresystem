                  ...
                  <div class="block-body">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input name="momvoter" type="text" class="form-control">
                        </div>
                      </div>
                        <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Last Name</label>
                        <div class="col-sm-9">
                          <input name="momlname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">First Name</label>
                        <div class="col-sm-9">
                          <input name="momfname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Middle Name</label>
                        <div class="col-sm-9">
                          <input name="mommname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Suffix</label>
                        <div class="col-sm-9">
                          <input name="momsuffix" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3 select">
                          <select name="mommonth" class="form-control">
                        ...
                        <div class="col-sm-3 select">
                          <select name="momday" class="form-control">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>04</option>
                        ...
                        <div class="col-sm-3 select">
                          <select name="momyear" class="form-control">
                            <option>2000</option>
                            <option>1999</option>
                            <option>1998</option>
                            <option>1997</option>
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Voters ID</label>
                        <div class="col-sm-9">
                          <input name="dadvoter" type="text" class="form-control">
                        </div>
                      </div>
                        <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Last Name</label>
                        <div class="col-sm-9">
                          <input name="dadlname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">First Name</label>
                        <div class="col-sm-9">
                          <input name="dadfname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Middle Name</label>
                        <div class="col-sm-9">
                          <input name="dadmname" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Suffix</label>
                        <div class="col-sm-9">
                          <input name="dadsuffix" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Birthdate</label>
                        <div class="col-sm-3 select">
                          <select name="dadmonth" class="form-control">
                            <option>January</option>
                            <option>February</option>
                            <option>March</option>
                            <option>April</option>
                        ...
                        <div class="col-sm-3 select">
                          <select name="dadday" class="form-control">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>04</option>
                        ...
                        <div class="col-sm-3 select">
                          <select name="dadyear" class="form-control">
                            <option>2000</option>
                            <option>1999</option>
                            <option>1998</option>
                            <option>1997</option>
                      ...
                      <div class="form-group row">
                          <div class="col-sm-9 ml-auto">
                              ...
                              <button type="regparentssubmit" class="btn btn-primary">Submit</button>
                          </div>
                      </div>
                      </form><!-- HERE -->
                      </div>   
